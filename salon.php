...
<head>
    ...
    <title>Omay Company Limited | Best Salon Supplies In Ghana</title>
    <meta name="description" content="We provide almost all you need for your Salons. Our catalogue includes Wig Heads, Stnads, Make-up organizers and many more"/>
    <!-- Font Awesome -->
...
?>
        ...
        <body>
            ...
            <nav style="padding-left: 25px;" class="d-flex justify-content-center">
                <ul class="row filters pagination pg-blue">
                    ...
                    <li data-filter=".wig" class="page-item">
                        <a class="page-link border" href="#topcat">Wig Stands</a>
                    </li>
                    <li data-filter=".lips"  class="page-item">
                        <a class="page-link border">Lipstic Stands</a>
                    </li>
                    <li data-filter=".nail"  class="page-item">
                        <a class="page-link border">Nail Polish Stands</a>
                    </li>
                    <li data-filter=".pencil"  class="page-item">
                        <a class="page-link border">Pencil Stands</a>
                    </li>
                    <li data-filter=".makeup"  class="page-item">
                        <a class="page-link border">Makeup Box</a>
                    </li>
                </ul>
            </nav>
            <!--Pagination-->
    ...
    <div class="fluid-container projects">
        ...
        <div class="row">
            <!--Grid column-->
            <div class="col-lg-3 col-md-4 col-sm-6 col-6 mb-4 item nail">
                <!--Card-->
                <div class="card">
                    <!--Card image-->
                    <div class="view overlay">
                        <img src="img/nail/n1.jpg" class="card-img-top" alt="">
                        <a>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 col-6 mb-4 item nail">
                ...
                <div class="card">
                    <!--Card image-->
                    <div class="view overlay">
                        <img src="img/nail/n2.jpg" class="card-img-top" alt="">
                        <a>
                            <div class="mask rgba-white-slight waves-effect waves-light"></div>
                        </a>
                    </div>
            ...
            <!--Grid column-->
            <div class="col-lg-3 col-md-4 col-sm-6 col-6 mb-4 item makeup">
                <!--Card-->
                <div class="card">
                    <!--Card image-->
                    <div class="view overlay">
                        <img src="img/makeup/m1.jpg" class="card-img-top" alt="">
                        <a>
                            <div class="mask rgba-white-slight waves-effect waves-light"></div>
                        </a>
                    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 col-6 mb-4 item makeup">
                ...
                <div class="card">
                    <!--Card image-->
                    <div class="view overlay">
                        <img src="img/makeup/m2new.jpg" class="card-img-top" alt="">
                        <a>
                            <div class="mask rgba-white-slight waves-effect waves-light"></div>
                        </a>
                    </div>
            ...
            <!--Grid column-->
            <div class="col-lg-3 col-md-4 col-sm-6 col-6 mb-4 item pencil">
                <!--Card-->
                <div class="card">

                    <!--Card image-->
                    <div class="view overlay">
                        <img src="img/pencil/p1.jpg" class="card-img-top" alt="">
                        <a>
                            <div class="mask rgba-white-slight waves-effect waves-light"></div>
                        </a>
                    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 col-6 mb-4 item pencil">
                ...
                <div class="card">
                    <!--Card image-->
                    <div class="view overlay">
                        <img src="img/pencil/p2.jpg" class="card-img-top" alt="">
                        <a>
                            <div class="mask rgba-white-slight waves-effect waves-light"></div>
                        </a>
                    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 col-6 mb-4 item pencil">
                ...
                <div class="card">
                    ...
                    <!--Card image-->
                    <div class="view overlay">
                        <img src="img/pencil/p3.jpg" class="card-img-top" alt="">
                        <a>
                            <div class="mask rgba-white-slight waves-effect waves-light"></div>
                        </a>
                    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 col-6 mb-4 item pencil">
                ...
                <div class="card">
                    ...
                    <!--Card image-->
                    <div class="view overlay">
                        <img src="img/pencil/p4.jpg" class="card-img-top" alt="">
                        <a>
                            <div class="mask rgba-white-slight waves-effect waves-light"></div>
                        </a>
                    </div>
            ...
            <!--Grid column-->
            <div class="col-lg-3 col-md-4 col-sm-6 col-6 mb-4 item wig">
                ...
                <div class="card">
                    ...
                    <!--Card image-->
                    <div class="view overlay">
                        <img src="img/wig/w1.jpg" class="card-img-top" alt="">
                        <a>
                            <div class="mask rgba-white-slight waves-effect waves-light"></div>
                        </a>
                    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 col-6 mb-4 item wig">
                ...
                <div class="card">
                    ...
                    <!--Card image-->
                    <div class="view overlay">
                        <img src="img/wig/w2.jpg" class="card-img-top" alt="">
                        <a>
                            <div class="mask rgba-white-slight waves-effect waves-light"></div>
                        </a>
                    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 col-6 mb-4 item wig">
                ...
                <div class="card">
                    ...
                    <!--Card image-->
                    <div class="view overlay">
                        <img src="img/wig/w3.jpg" class="card-img-top" alt="">
                        <a>
                            <div class="mask rgba-white-slight waves-effect waves-light"></div>
                        </a>
                    </div>
            ...
            <div class="card">
                ...
                <!--Card image-->
                <div class="view overlay">
                    <img src="img/wig/w4.jpg" class="card-img-top" alt="">
                    <a>
                        <div class="mask rgba-white-slight waves-effect waves-light"></div>
                    </a>
                </div>
            ...
            <!--Grid column-->
            <div class="col-lg-3 col-md-4 col-sm-6 col-6 mb-4 item lips">
            ...
            <div class="card">
                ...
                <!--Card image-->
                <div class="view overlay">
                    <img src="img/l1.jpg" class="card-img-top" alt="">
                    <a>
                        <div class="mask rgba-white-slight waves-effect waves-light"></div>
                    </a>
                </div>
            ...
            <div class="card">
                ...
                <!--Card image-->
                <div class="view overlay">
                    <img src="img/l2.jpg" class="card-img-top" alt="">
                    <a>
                        <div class="mask rgba-white-slight waves-effect waves-light"></div>
                    </a>
                </div>
